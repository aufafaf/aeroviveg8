...
import { Wind, Droplets, Gauge, Activity, MapPin, Wifi, Battery, Sun, Fan, AlertTriangle, MapPinOff } from 'lucide-react';
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-6">Dashboard Monitoring Real-Time</h2>
              ...
              <div className="bg-gradient-to-br from-yellow-400 to-orange-500 rounded-xl p-4 text-white">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm opacity-90">Solar Panel</p>
                    <p className="text-3xl font-bold">ON</p>
                    <p className="text-xs mt-1">Charging: 85%</p>
                  </div>
                  <Sun className="w-12 h-12 opacity-50" />
                </div>
              </div>

              <div className="bg-gradient-to-br from-teal-400 to-cyan-600 rounded-xl p-4 text-white">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm opacity-90">Fan Status</p>
                    <p className="text-3xl font-bold">Running</p>
                    <p className="text-xs mt-1">Speed: 1150 RPM</p>
                  </div>
                  <Fan className="w-12 h-12 opacity-50" />
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-red-400 to-pink-600 rounded-xl p-4 text-white">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm opacity-90">Hotspot Polusi</p>
                    <p className="text-3xl font-bold">3</p>
                    <p className="text-xs mt-1">Area terburuk</p>
                  </div>
                  <MapPinOff className="w-12 h-12 opacity-50" />
                </div>
              </div>

              <div className="bg-gradient-to-br from-amber-500 to-red-600 rounded-xl p-4 text-white">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm opacity-90">Alerts</p>
                    <p className="text-3xl font-bold">3</p>
                    <p className="text-xs mt-1">Maintenance</p>
                  </div>
...
//                   <div className="flex items-center gap-2">
//                     <div className="w-4 h-4 bg-red-400 rounded"></div>
//                     <span className="text-xs text-gray-600">Berbahaya 150+</span>
//                   </div>
//                 </div>
//               </div>
...
//                         <span className="text-xs bg-green-100 text-green-700 px-2 py-0.5 rounded">Solar: ON</span>
//                         <span className="text-xs bg-blue-100 text-blue-700 px-2 py-0.5 rounded">Fan: Running</span>
//                       </div>
//                     </div>
...
//                           <p className="text-xs text-gray-500">Kampung Melayu</p>
//                         </div>
//                         <div className="text-right"></div></div></div></div></div></div></div></div>)}</div></div>)}
//                         export default OutdoorAirPurifier;